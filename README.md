...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.mikkoi/projects-maven-plugin.svg)](https://mvnrepository.com/artifact/com.github.mikkoi/projects-maven-plugin)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=mikkoi_projects-maven-plugin&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=mikkoi_projects-maven-plugin)
[![codecov](https://codecov.io/gh/mikkoi/projects-maven-plugin/graph/badge.svg?token=01Z5MT16DB)](https://codecov.io/gh/mikkoi/projects-maven-plugin)

# Projects Maven Plugin

# Introduction

This is a Maven plugin to perform operations on all or a subset of projects in a multi-module build.
It can be used to list projects, add dynamically during build dependencies to a (sub)project,
or create a BOM (Bill Of Materials) project.
It supports _includes_ and _excludes_ patterns to filter projects.
