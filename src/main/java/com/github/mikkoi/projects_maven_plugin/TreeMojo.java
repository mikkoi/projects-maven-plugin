...
/**
 * List all projects in the build in a tree format.
 * Work in Progress.
 */
@Mojo(name = "tree")
public class TreeMojo extends BaseMojo {
     ...
     */
    @Parameter(property = "projects" + ".tree" + ".excludes")
     ...
     */
    @Parameter(property = "projects" + ".tree" + ".includes")
    private List<String> includes;

    /**
     * Sorting order: maven | alphabetic, default: maven
     */
    @Parameter(property = "projects" + ".tree" + ".sortOrder", defaultValue = "maven")
    String sortOrder;

    /**
     * Format for printing.
     */
    @Parameter(property = "projects" + ".tree" + ".printFormat", defaultValue = "{groupId}:{artifactId}")
    private String printFormat;

    /**
     * Indent size: nr of chars , default: 2 chars
     */
    @Parameter(property = "projects" + ".tree" + ".indent", defaultValue = "2")
    String indent;
